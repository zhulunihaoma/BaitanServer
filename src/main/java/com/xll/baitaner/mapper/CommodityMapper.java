...
public interface CommodityMapper {
     ...
     * @return
     */
    @Insert("INSERT INTO commodity (shopId,sortId,name,price,retail_price,postage,monthlySales,pictUrl,zipPicUrl,wxcodeUrl," +
            "introduction,introductionPics," +
            "state,turn,stock,datetime) VALUES (#{co.shopId},#{co.sortId},#{co.name},#{co.price},#{co.retailPrice}," +
            "#{co.postage}," +
            "#{co.monthlySales},#{co.pictUrl},#{co.zipPicUrl},#{co.wxcodeUrl}," +
            "#{co.introduction},#{co.introductionPics},#{co.state},#{co.turn},#{co.stock},NOW(0))")
    ...
    @Update("UPDATE commodity SET name=#{co.name},price=#{co.price},retail_price=#{co.retailPrice},postage=#{co.postage}," +
            ...
            "pictUrl = #{co.pictUrl},zipPicUrl=#{co.zipPicUrl},wxcodeUrl=#{co.wxcodeUrl},introduction=#{co.introduction},introductionPics=#{co.introductionPics},stock=#{co.stock} " +
            "WHERE id  = #{co.id}")
